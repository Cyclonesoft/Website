    ...
    var inStream = fs.createReadStream(__dirname + "/../../files/" + filename + ".thr")
        ...
        .pipe(es.mapSync(function (line) {
            ...
            .on('error', function (err) {
                console.log('Error al leer el archivo', err); // Error while reading file
            })
            .on('end', function () {
                console.log('Conversión Realizada' + filename + '.thr a Gcode'); // Done converting ' + filename + '.thr to gcode'
