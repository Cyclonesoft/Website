...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    }, 2000); // Actulizacion de los patrones cada segundo
  }
  ...
  onTrackClickedFn(trackName, mode) {
    ...
    switch (mode) {
      ...
      case "delete":
        ...
        break;
      case "rename":
        var newName = prompt("Ingrese un nuevo nombre para este patrón:", trackName); //"Enter a new name for this track:",
      ...
      case "playPlaylist":
        this.setState((state, props) => {
          return {
            currentTracks: trackName, // en Este caso, trackName es un listado de patrones
          };
        });
        break;
    }
    ...
    return (
      <>
        <Container className="h-100">
          <h1 className="text-center m-0 mb-2">Sandsara</h1>
