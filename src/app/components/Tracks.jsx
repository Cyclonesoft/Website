  ...
  render() {
    return (
      <Tabs className="mt-3" justify variant="pills" defaultActiveKey="tracks">
        <Tab eventKey="tracks" title="Patrón" tabClassName="btn-outline-light">
          <Col
            className="mt-2"
          ...
          <Navbar fixed="bottom" bg="dark">
            ...
            >
              {this.props.loading ? (
                ...
                <>
                  <IoMdCloudUpload />
                  <span className="pl-2">Subir un nuevo patron </span>
                  <input
                    type="file"
                    accept=".thr"
        ...
        <Tab
          eventKey="playlists"
          title="Lista de Reproducción" // "Playlists"
        ...
        >
          ...
          <Navbar fixed="bottom" bg="dark">
            <Button
              ...
              style={{ width: "15em", height: "2.5em" }}
              onClick={() => {
                var newName = prompt("Ingrese el nombre para esta lista de reproducción:", ""); // "Enter a name for this playlist:"
            ...
            >
              <IoIosCreate />
              <span className="pl-2">Nueva lista de reproducción</span>
            </Button>
          </Navbar>
        </Tab>
      </Tabs>
