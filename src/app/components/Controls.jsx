        ...
        <Col>
          <Card className="mt-3">
            <Card.Header className="d-flex align-items-center">
              <h5 className="d-inline-block m-0">Ahora se esta dibujando...</h5>
          ...
          <Card className="py-2 px-3 mt-4 d-flex align-items-center flex-row">
            <h5 className="m-0 mr-4 p-0">Velocidad: </h5>
            <span className="w-100">
              <RangeSlider
                ...
                inputProps={{
                  onMouseUp: () => {
                    console.log("Velocidad Fijada a: " + this.state.speed);
